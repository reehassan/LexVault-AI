...
from apps.documents.services.embedder import embed_chunks, EMBEDDING_DIM, InvalidChunkInputError


def test_embed_chunks_single_chunk_returns_correct_dimension():
    chunks = [{"chunk_text": "This is a test sentence about contracts."}]
